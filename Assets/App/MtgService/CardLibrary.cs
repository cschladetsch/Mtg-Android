...
namespace App.MtgService {
    public class CardLibrary : MonoBehaviour {
        ...
        public string DataPath = UnityEngine.Application.persistentDataPath;
        ...
        private Card AddCard(GoogleVisionResponse visionResponse) {
            ...
            var title = Util.ClosestStringMatch.Find(rawTitle, _allCardNames.data);
        ...
        private Card ProcessVisualAnalysisResponse(GoogleVisionResponse visionResponse) {
            ...
            if (visionResponse.responses.Count == 0) {
                Log.Error("Got multiple visual responses. Can't disabmbiguate");
                return null;
            }
